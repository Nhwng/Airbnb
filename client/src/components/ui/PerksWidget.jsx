      ...
      <div className="mt-4 grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4">
        {amenities
          ...
          .map((a) => (
            ...
            >
              {perkIcons[a.title] || (
                <span className="h-5 w-5 rounded-full bg-gray-300 flex items-center justify-center text-xs text-gray-500">
                  <span>✓</span>
                </span>
              )}
