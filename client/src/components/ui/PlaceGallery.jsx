...
const PlaceGallery = ({ photos = [] }) => {
  ...
  if (!photos || photos.length === 0) {
    return (
      <div className="relative h-[400px] bg-gray-200 rounded-[12px] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 text-sm mt-1">Images for this property are currently unavailable</p>
        </div>
      </div>
    );
  }
